INSERT INTO GelderlandDist(name,District,CountryCode,Inauguration)VALUES("Sakila","Gelderland",'SQL','2001-7-1');
...
UPDATE copiaCity set population=(select population from city where name='Ede' order by population desc limit 1 ) where name='Cambridge' AND district='England' order by population desc limit 1
