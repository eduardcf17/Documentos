...
INSERT INTO empresa.EMP VALUES (7566,'JIM�NEZ','DIRECTOR',7839, '1981-04-02', 386750,NULL,20);
INSERT INTO empresa.EMP VALUES (7654,'MART�N','VENDEDOR',7698, '1981-09-29', 162500,182000,30);
...
INSERT INTO empresa.CLIENTE (CLIENTE_COD, NOMBRE, DIRECCIÓN, CIUDAD, ESTADO, CODI_POSTAL, AREA, 
...
INSERT INTO empresa.PRODUCTO (PROD_NUM, DESCRIPCIÓN)
...
CREATE TABLE IF NOT EXISTS empresa.COMANDA  (
 ...
 COM_FECHA           DATE,
 COM_TIPO          CHAR (1) CHECK (COM_TIPUS IN ('A','B','C')),
